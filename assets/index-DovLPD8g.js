...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Jn,depthTest:!1,depthWrite:!1})}function Yc(){return new zn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:la(),fragmentShader:`
		...
		`,blending:Jn,depthTest:!1,depthWrite:!1})}function qc(){return new zn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:la(),fragmentShader:`
...
`].filter(qr).join(`
`)),a=nl(a),a=ih(a,e),a=rh(a,e),o=nl(o),o=ih(o,e),o=rh(o,e),a=sh(a),o=sh(o),e.isRawShaderMaterial!==!0&&(S=`#version 300 es
...
`)+`
`+d);const b=S+m+a,y=S+d+o,E=th(i,i.VERTEX_SHADER,b),A=th(i,i.FRAGMENT_SHADER,y);i.attachShader(_,E),i.attachShader(_,A),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function w(P){if(r.debug.checkShaderErrors){const N=i.getProgramInfoLog(_)||"",F=i.getShaderInfoLog(E)||"",W=i.getShaderInfoLog(A)||"",G=N.trim(),k=F.trim(),z=W.trim();let K=!0,ot=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(K=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,E,A);else{const et=nh(i,E,"vertex"),ct=nh(i,A,"fragment");Wt("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
